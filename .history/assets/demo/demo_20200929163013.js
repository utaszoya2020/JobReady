  ...
  initNowUiWizard: function() {
    ...
    $('.card-wizard').bootstrapWizard({
      ...
      onFinish: function(tab, navigation, index) {
        ...
        $($wizard).find('.moving-tab').hide();
        $($wizard).find('.info-text').html('Thank you for submitting your documents, we will verify your documents and get back to you as soon as possible');
      },
